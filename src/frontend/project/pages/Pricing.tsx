      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            {plans.map((plan) => (
              <div key={plan.name} className={`relative overflow-hidden rounded-lg shadow-lg ${theme.colors.card.gradient} backdrop-blur-sm p-8 ${plan.popular ? `ring-2 ${theme.colors.primary.border}` : ''} w-full max-w-sm`}>
              {plan.popular && (
